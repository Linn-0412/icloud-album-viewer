...
export function isUsableMarker(marker, confidenceThreshold = 0.72) {
  return (
    marker &&
...
export function combineDateWithPhotoTime(markerEpoch, photoEpoch) {
...
export function applyDateMarkers(photos, markers, options = {}) {
...
export function inferAlbumOrderDateMarkers(photos, options = {}) {
  const photosByAlbumOrder = [...photos].sort((a, b) => Number(a.index || 0) - Number(b.index || 0));
...
export function applyInferredDateCards(photos, options = {}) {
